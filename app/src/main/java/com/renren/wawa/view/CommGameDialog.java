...
public class CommGameDialog extends Dialog implements View.OnClickListener {
    ...
    private RelativeLayout commDialogContent;
     ...
     * @param
     */
    public CommGameDialog(Context context, String title, String message, boolean single) {
    ...
    public CommGameDialog(Context context, String title, int customLayoutResId, boolean single) {
        super(context, R.style.CommDialogStyle);
        this.title = title;
    ...
    public CommGameDialog(Context context, String title, String message, int customLayoutResId, boolean single) {
        super(context, R.style.CommDialogStyle);
        this.title = title;
        this.message = message;
        this.customLayoutResId = customLayoutResId;
    ...
    public CommGameDialog(Context context, String title, String message, boolean isContentHtml, boolean single) {
        super(context, R.style.CommDialogStyle);
        this.title = title;
        this.message = message;
        this.single = single;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rootView = LayoutInflater.from(getContext()).inflate(R.layout.comm_game_dialog_view, null);
        setContentView(rootView);

        findViewById(R.id.comm_dialog_root).setOnClickListener(this);

        commDialogContent = findViewById(R.id.comm_dialog_content);
    ...
    public void setCommDialogContent(int bg){
        commDialogContent.setBackgroundResource(bg);
    }
...
//        lp.width = WindowManager.LayoutParams.MATCH_PARENT;
    ...
    public void setLeftButtonPositive(boolean positive) {
        if (positive) {
            leftBtn.setTextColor(mContext.getResources().getColor(R.color.white));
            //ViewUtil.setBackground(leftBtn, mContext.getResources().getDrawable(R.drawable.bg_corners_btn_theme));
        } else {
            leftBtn.setTextColor(mContext.getResources().getColor(R.color.white));
            //ViewUtil.setBackground(leftBtn, mContext.getResources().getDrawable(R.drawable.bg_corners_btn_theme));
        }
    ...
    public void setRightButtonPositive(boolean positive) {
        if (positive) {
            rightBtn.setTextColor(mContext.getResources().getColor(R.color.white));
            //ViewUtil.setBackground(rightBtn, mContext.getResources().getDrawable(R.drawable.bg_corners_btn_theme));
        } else {
            rightBtn.setTextColor(mContext.getResources().getColor(R.color.white));
            //ViewUtil.setBackground(rightBtn, mContext.getResources().getDrawable(R.drawable.bg_corners_btn_theme));
        }
